...
<div class="wrap af-shell af-dashboard">
	...
	<section class="af-section" aria-labelledby="af-calendar-title" id="af-alerts">
		...
		<?php
		$cal_base_year  = (int) gmdate( 'Y', strtotime( $calendar_from ) );
		$cal_base_month = (int) gmdate( 'n', strtotime( $calendar_from ) );
		?>
						...
						<div class="af-modal__field">
							...
							<select id="af-cal-accommodation">
								...
								if ( is_array( $calendar_scope_ids ) ) {
									$cal_prop_ids = array_values( array_intersect( $cal_prop_ids, array_map( 'intval', $calendar_scope_ids ) ) );
								}
